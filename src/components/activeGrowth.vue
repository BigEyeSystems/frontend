...
<template>
    <div class="text-xs">
        ...
        <div v-if="showGradationGrowth">
            ...
            <div class="bg-[#17181C] p-2 rounded-xl cursor-pointer my-4 flex justify-between items-center" @click="downloadGradationGrowthFile(gradationActiveData?.file_id)">
